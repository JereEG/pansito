...
app.post("/webhook", async (req, res) => {
  ...
  if (message?.type === "text") {
    // console.log("📩 Mensaje recibido de:", message.from); // Imprime el número del remitente
    // console.log("📜 Contenido del mensaje:", message.text.body); // Imprime el contenido del mensaje
